...
function setup() {
  ...
  ground = new Ground (200, 380, 1000, 25);
  superhero= new Superhero(400,3,100,100);
  attach=new Throw(superhero.body,{x:100,y:465});
  block1 = new Block(350,280,30,40);  
  block2 = new Block(375,265,30,40);
  block3 = new Block(405,260,30,40);
  ...
  monster = new Monster(480,140,100,100);
